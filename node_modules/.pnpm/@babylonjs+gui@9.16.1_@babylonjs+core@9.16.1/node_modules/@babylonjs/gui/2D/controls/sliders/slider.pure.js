...
let Slider = (() => {
    ...
    let _get_displayValueBar_decorators;
    let _get_borderColor_decorators;
    let _get_background_decorators;
    let _get_thumbColor_decorators;
    let _get_isThumbCircle_decorators;
    return _a = class Slider extends _classSuper {
        ...
        (() => {
            ...
            _get_displayValueBar_decorators = [serialize()];
            _get_borderColor_decorators = [serialize()];
            _get_background_decorators = [serialize()];
            _get_thumbColor_decorators = [serialize()];
            _get_isThumbCircle_decorators = [serialize()];
            __esDecorate(_a, null, _get_displayValueBar_decorators, { kind: "getter", name: "displayValueBar", static: false, private: false, access: { has: obj => "displayValueBar" in obj, get: obj => obj.displayValueBar }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_borderColor_decorators, { kind: "getter", name: "borderColor", static: false, private: false, access: { has: obj => "borderColor" in obj, get: obj => obj.borderColor }, metadata: _metadata }, null, _instanceExtraInitializers);
            ...
            __esDecorate(_a, null, _get_thumbColor_decorators, { kind: "getter", name: "thumbColor", static: false, private: false, access: { has: obj => "thumbColor" in obj, get: obj => obj.thumbColor }, metadata: _metadata }, null, _instanceExtraInitializers);
            __esDecorate(_a, null, _get_isThumbCircle_decorators, { kind: "getter", name: "isThumbCircle", static: false, private: false, access: { has: obj => "isThumbCircle" in obj, get: obj => obj.isThumbCircle }, metadata: _metadata }, null, _instanceExtraInitializers);
